...
def main(train_args, eval_args, save_dir):
    ...
    state_seqs, obs_seqs = p.sample_multiple_sequences(key, theta, eval_args.num_seqs, eval_args.seq_length)
    ...
    utils.plot_multiple_length_smoothing(state_seqs, smoothing_p_theta, smoothing_q_phi, timesteps, 'kalman_theta', 'kalman_phi', save_dir)
