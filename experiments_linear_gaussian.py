...
elbo_sequences = vmap(get_elbo(p_aux), in_axes=(0, None, None, None, None))(obs_samples, p_params, p_params)
...
loss = partial(get_elbo(p_aux, q_aux), p_aux=p_aux, q_aux=q_aux)
