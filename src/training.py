                ...
                if self.true_online: 
                    if 'v1' in training_mode:
                        ...
                        def _step(carry, x):
                            ...
                            return new_carry, elbo_t, grad_t, aux
                        
                        new_carry, elbo_t, grad_t, aux = _step(elbo_carry, (key, timesteps, strided_ys))

                        neg_elbo = -elbo_t / (timesteps+1)
