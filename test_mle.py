...
avg_likelihood = jax.vmap(p.likelihood_seq, in_axes=(0, None))(obs_seqs, theta).sum()
print('Avg logl', avg_likelihood)
theta_mle, avg_logls = p.fit_kalman_rmle(key_mle, obs_seqs, 'adam', 1e-3, num_seqs // 20, 10)
