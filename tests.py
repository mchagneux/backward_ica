...
elbo = get_appropriate_elbo('linear_gaussian','linear_emission')(p=hmm.model,q=hmm.model)

evidence_from_elbo  = elbo(observations)


print(torch.abs(evidence_from_elbo-true_evidence))
