...
settings_list = ['johnson_backward,100.10.adam,1e-2,cst.online,2.score,paris,variance_reduction,bptt_depth_2',
                 'johnson_backward,100.10.adam,1e-2,cst.online,100000,reset.autodiff_on_backward']
