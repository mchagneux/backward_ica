...
settings_list = ['linear.100.adam,1e-3,cst.true_online,100.score,share_params,paris,variance_reduction,bptt_depth_1',
                 'linear.100.adam,1e-3,cst.true_online,100.score,paris,variance_reduction,bptt_depth_1']
num_fits = 1
num_epochs = 1
dims = '5 5'
