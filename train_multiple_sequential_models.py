...
settings_list = ['johnson_backward,10.100.adam,1e-3,cst.true_online,500.score,truncated,variance_reduction,paris,bptt_depth_1']
num_fits = 1
num_epochs = 1
dims = '5 5'
load_from = 'data/crnn/2023-06-26_15-08-47_Train_run'
loaded_seq = True
batch_size = 1
num_seqs = 1
seq_length = 500
