...
settings_list = ['johnson_backward,100.10.adam,1e-1,cst.reset,2000.autodiff_on_backward',
                 'johnson_backward,100.10.adam,1e-1,cst.true_online.score,variance_reduction,bptt_depth_1']
