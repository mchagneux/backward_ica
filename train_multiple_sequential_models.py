...
settings_list = ['linear.5.adam,1e-2,cst.reset,500.autodiff_on_backward',
                 'johnson_backward,100.5.adam,1e-2,cst.reset,500.autodiff_on_backward']


num_epochs = 10000
dims = '20 20'
load_from = 'data/crnn/2023-06-06_17-10-41_Train_run'
loaded_seq = True
batch_size = 1
num_seqs = 1
seq_length = 500
