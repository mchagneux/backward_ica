...
settings_list = ['johnson_backward,100.10.adam,1e-3,cst.true_online,difference.score,paris,variance_reduction,bptt_depth_2']

num_epochs = 1
dims = '20 20'
load_from = 'data/crnn/2023-06-06_20-42-22_Train_run'
loaded_seq = True
batch_size = 1
num_seqs = 1
seq_length = 500000
