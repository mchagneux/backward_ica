...
settings_list = ['johnson_backward,100.10.adam,1e-3,cst.reset,500,1.score,paris,variance_reduction,bptt_depth_2',
                 'johnson_backward,100.10.adam,1e-3,cst.reset,500,1.autodiff_on_backward']
