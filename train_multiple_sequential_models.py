...
settings_list = ['johnson_backward.2.adam,1e-4,cst.online,50,reset.autodiff_on_backward',
                 'johnson_backward.2.adam,1e-4,cst.online,50,reset.score,variance_reduction,bptt_depth_2']
