...
settings_list = ['johnson_backward.10.adam,1e-3,cst.online,50,reset.autodiff_on_backward',
                 'johnson_backward.10.adam,1e-3,cst.online,50.score,paris,variance_reduction,bptt_depth_2']
