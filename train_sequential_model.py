...
if __name__ == '__main__':
    ...
    parser.add_argument('--model', type=str, default='johnson_backward__online_50_score_paris')
    parser.add_argument('--exp_dir', type=str, default='experiments/p_chaotic_rnn/2023_05_09__11_54_12')
